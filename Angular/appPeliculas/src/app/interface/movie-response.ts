// To parse this data:
//
//   import { Convert, MovieResponse } from "./file";
//
//   const movieResponse = Convert.toMovieResponse(json);
//
...
const typeMap: any = {
    "MovieResponse": o([
        ...
        { json: "backdrop_path", js: "backdrop_path", typ: null },
        ...
        { json: "production_companies", js: "production_companies", typ: a("any") },
